...
// Start the server without Redis
app.listen(PORT, () => {
  console.log('\n🚀 SmartClips API Server started (NO REDIS MODE)!');
  console.log(`📍 Server: http://localhost:${PORT}`);
  console.log(`📊 Health check: http://localhost:${PORT}/api/health`);
  console.log(`🤖 AI Script Generator: http://localhost:${PORT}/api/ai-script-generator`);
  console.log(`🔧 Environment: ${process.env.NODE_ENV || 'development'}`);
  console.log('⚠️  Note: Queue-based features are disabled');
