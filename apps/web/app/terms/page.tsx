      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-bold mb-2">SmartClips Terms of Service</h1>
            ...
            <div className="space-y-6">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">1. Legal Notice / Purpose of These Policies</h2>
                <p className="text-muted-foreground">
              ...
              <section className="space-y-3">
                ...
                <p className="text-muted-foreground">To use SmartClips, you must be:</p>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">4. Account Registration & Security</h2>
                <p className="text-muted-foreground">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">5. Email + Marketing Communication Consent</h2>
                <p className="text-muted-foreground">
                ...
                <div className="space-y-4 ml-4">
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Service & Account Communications</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Product Updates & Onboarding</h3>
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">6. Subscription Plans, Billing, and Payment</h2>
                <p className="text-muted-foreground">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">7. Free Trials</h2>
                <p className="text-muted-foreground">If SmartClips provides a free trial:</p>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">8. Refund Policy (No Refunds / Anti-Chargeback Protection)</h2>
                <p className="text-muted-foreground">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">9. User Content & Ownership</h2>
                <p className="text-muted-foreground">
                  "User Content" means any content you upload, submit, create, or edit using SmartClips, including video, audio, images, and text.
                </p>
                <h3 className="font-semibold text-lg mb-2">You Own Your Content</h3>
                <p className="text-muted-foreground">You retain ownership of your User Content.</p>
                <h3 className="font-semibold text-lg mb-2">License You Grant SmartClips</h3>
                <p className="text-muted-foreground">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">10. AI-Generated Output Disclaimer</h2>
                <p className="text-muted-foreground">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">11. COPYRIGHT + INTELLECTUAL PROPERTY</h2>
                <p className="text-muted-foreground">
                  SmartClips respects intellectual property rights and expects all users to do the same.
                </p>
                <h3 className="font-semibold text-lg mb-2">A. Your Content Must Be Yours</h3>
                <p className="text-muted-foreground">By uploading content to SmartClips, you represent and warrant that:</p>
                <ol className="list-decimal list-inside space-y-2 text-muted-foreground ml-4">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">12. Acceptable Use Policy</h2>
                <p className="text-muted-foreground">You agree not to use SmartClips for:</p>
                <div className="space-y-3 ml-4">
                  <div>
                    <h3 className="font-semibold text-lg">Illegal or Harmful Activity</h3>
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg">Copyright / Stolen Content</h3>
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg">Fraud / Scams / Deceptive Media</h3>
                    <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">17. Governing Law & Dispute Resolution</h2>
                <p className="text-muted-foreground">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">18. No Guarantees or Promises of Results</h2>
                <p className="text-muted-foreground">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">19. Data & Privacy</h2>
                <p className="text-muted-foreground">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">20. Changes to the Terms</h2>
                <p className="text-muted-foreground">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">21. Severability</h2>
                <p className="text-muted-foreground">
              ...
              <section className="space-y-3">
                <h2 className="text-2xl font-bold">22. Contact Information</h2>
                <p className="text-muted-foreground">
